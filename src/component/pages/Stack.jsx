      ...
      <div className="shell">
        ...
        <main className="stack-shell-bodyII">
          ...
          <p>
            ...
            elements. The Stack follows a LIFO (Last In First Out) principal in
            that the last inserted item in the stack is the first item removed.
            In a real world example with a stack of plates, a plate can be
            inserted at the top of the stack and removed from the top of the
            stack.
          </p>
          <hr></hr>
          <h2>Push Method</h2>
          <p>
            The push method for a stack is used to add an element into the
            collection at the top of the stack
          </p>
          ...
          <h2>Pop Method</h2>
          <p>
            The pop method for a stack is used to remove the top-most element
            from the stack
          </p>
          ...
          <h2>Peek Method</h2>
          <p>
            The peek method will return the value of the top element and will
